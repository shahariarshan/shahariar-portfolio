...
import f1 from '../../src/assets/Annotation 2023-12-12 191344.png'
import f2 from '../../src/assets/Annotation 2023-12-12 191412.png'
import f3 from '../../src/assets/Annotation 2023-12-12 191510.png'
...
const Projects = () => {
    ...
    return (
        <div name='Projects' data-aos="flip-left">
                    ...
                    <div className="card shadow-xl mt-5">
                        ...
                        <div className="card-body text-center">
                            ...
                            <div className="flex mx-auto gap-2">
                                ...
                                <i className="material-icons"><img src={node} alt="" className="h-[40px] w-[40px]" /></i>
